...
# #Formations Scripts	  
  ...
  ("form_cavalry", [
	...
	#add by windmelodie for no limit begin

	(store_add, ":slot", slot_team_d0_formation_space, ":fdivision"),
	(team_get_slot, ":fformation", ":fteam", ":slot"),
	(try_begin),
		(neg|eq,":fformation",formation_wedge),
		(call_script, "script_form_infantry", ":fteam", ":fdivision", ":fleader", ":formation_extra_spacing", ":fformation"),
	(else_try),
	
	#add by windmelodie for no limit end
...
#		(neg|faction_slot_eq,"fac_mod_variables",slot_Mod_formation_nolimit,1),
		(assign, ":num_troops", 1),
	(try_end),
