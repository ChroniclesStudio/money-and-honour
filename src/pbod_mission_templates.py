...
## windmelodie edited for 16th key order
caba_order_triggers = [
	...
	(0, 0, 0, [(this_or_next|key_clicked, "$key_order_10"),(key_clicked, key_escape)], [(party_set_slot, "p_main_party", slot_party_gk_order, 0),(is_presentation_active, "prsnt_caba_order_display"),(presentation_set_duration, 0)]),
	...
	(0, 0, 0, [(game_key_clicked, gk_order_1),(neg|main_hero_fallen)], [
		...
		(else_try),
			...
			#(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, gk_order_2),	#Lines formation
			(call_script, "script_player_order_formations", mordr_charge),
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, gk_order_3),	#Ranged order
			(call_script, "script_order_volley_begin_end", end, "$fplayer_team_no"),
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, gk_order_4),	#WEAPON order
	...
	(0, 0, 0, [(game_key_clicked, gk_order_5),(neg|main_hero_fallen)], [
		...
		(else_try),
			...
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),		
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_7"),	#Shield
			(call_script, "script_order_set_display_text", shield),
			(call_script, "script_order_weapon_type_switch", shield, "$fplayer_team_no"),
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_8"),	#End Special Order
	...
	(0, 0, 0, [(game_key_clicked, gk_order_6),(neg|main_hero_fallen)], [
		(try_begin),
            ...
            (start_presentation, "prsnt_caba_order_display"),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, gk_order_1),	#ADVANCE
		...
		(else_try),
			...
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_7"),	#No Shield
			(call_script, "script_order_set_display_text", noshield),
			(call_script, "script_order_weapon_type_switch", noshield, "$fplayer_team_no"),
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_8"),	#Begin Skirmish
	...
	(0, 0, 0, [(key_clicked, "$key_order_7"),(neg|main_hero_fallen)], [
	    (try_begin),
			(party_slot_eq, "p_main_party", slot_party_gk_order, 0),
			(party_set_slot, "p_main_party", slot_party_gk_order, "$key_order_7"),
            (start_presentation, "prsnt_caba_order_display"),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, gk_order_1),	#FALL BACK
		...
		(else_try),
			...
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_7"),	#Free Shield
			...
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_8"),	#Volley
    ...
    (0, 0, 0, [(key_clicked, "$key_order_8"),(neg|main_hero_fallen)], [ #f7
	    (try_begin),
		    (party_slot_eq, "p_main_party", slot_party_gk_order, 0), 
		    (party_set_slot, "p_main_party", slot_party_gk_order, "$key_order_8"),
            (start_presentation, "prsnt_caba_order_display"),
		(else_try),
			...
			(party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, gk_order_6),  #ranged
			(call_script, "script_order_set_display_text", ranged),
		    (call_script, "script_order_weapon_type_switch", ranged, "$fplayer_team_no"),
		    (party_set_slot, "p_main_party", slot_party_gk_order, 0),
		(else_try),
			(party_slot_eq, "p_main_party", slot_party_gk_order, "$key_order_8"),	#Brace Spear
    ...
    (0, 0, 0, [(key_clicked, "$key_order_9"),(neg|main_hero_fallen)], [ #F8
	    (try_begin),
...
field_ai_triggers = [
  ...
  (0.1, 0, 0, [(call_script, "script_cf_order_active_check", slot_team_d0_order_sp_brace)], [ #spearwall_trigger_1
		(try_for_agents,":agent"),
           ...
           (ge,":speartimer",20),
		   (item_get_slot, ":spear_distence", ":weapon", slot_item_length), #CABA
           (assign, ":dist_to_beat", ":spear_distence"),
           (assign,":victim",-1),
		   (assign, ":vic_rider", -1),
           (agent_get_position,pos1,":agent"),
...
def modmerge_mission_templates(orig_mission_templates):
	...
	for i in range(len(orig_mission_templates)):
		...
		if ( trigger_i != None ):
			...
			isSeaBattle = codeblock.FindLineMatching((assign, "$water_battle", 0)) ## ZZ
			if ( isSeaBattle == -1 ): ##ZZ
