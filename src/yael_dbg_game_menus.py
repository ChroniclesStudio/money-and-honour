...
EQMGR_OPTION = (
    ...
    [
        (display_message, 
         "@Resetting $switch_presentation_new = 0 of formations "
         "modmerger mod, in order to fix 'Invalid Presentation ID "
         "at mission template mst_lead_charge no: 30 conditions' error."),
        (assign, "$switch_presentation_new", 0),

        (display_message, 
         "@Resetting item data with script_initialize_item_info. "
         "This should fix issue where it has become impossible to "
         "buy productive enterprises."),
